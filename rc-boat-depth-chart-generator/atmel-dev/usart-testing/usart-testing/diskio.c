/* disk.c and disk.h from https://github.com/jambu-aj/FatFS/blob/master/GccApplication1_FatFS_SDCard/GccApplication1_FatFS_SDCard/diskio.c using FatFs open-source library. */
/*----------------------------------------------------------------------------/
